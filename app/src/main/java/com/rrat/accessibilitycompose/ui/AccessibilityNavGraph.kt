...
import com.rrat.accessibilitycompose.ui.home.HomeScreen
...
fun AccessibilityNavGraph(
        ...
        startDestination = startDestination)
    {
        ...
        composable("${MainDestinations.ARTICLE_ROUTE}/{${MainDestinations.ARTICLE_ID_KEY}}"){
